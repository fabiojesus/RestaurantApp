...
namespace Recodme.Academy.RestaurantApp.WebApplication.Controllers.RestaurantControllers.Api.RestaurantControllers
{
    

    [Route("api/[controller]")]
    [ApiController]
    public class StaffTitlesController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromBody] StaffTitleViewModel vm)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] StaffTitleViewModel vm)
        {
