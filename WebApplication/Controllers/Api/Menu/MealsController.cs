...
namespace Recodme.Academy.RestaurantApp.WebApplication.Controllers.RestaurantControllers.Api.MenuControllers
{
    ...
    public class MealsController : ControllerBase
    {
        ...
        public async Task<IActionResult> ListAsync()
        {
            ...
            {
                var vm = MealViewModel.Parse(item);
                lst.Add(vm);
            }
            return Ok(lst);
        }
        ...
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromBody] MealViewModel vm)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] MealViewModel vm)
        {
