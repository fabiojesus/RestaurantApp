...
namespace Recodme.Academy.RestaurantApp.WebApplication.Controllers.RestaurantControllers.Api.MenuControllers
{
    ...
    public class CoursesController : ControllerBase
    {
        ...
        public async Task<IActionResult> ListAsync()
        {
            ...
            {
                var vm = CourseViewModel.Parse(item);
                lst.Add(vm);
            }
            return Ok(lst);
        }
        ...
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromBody] CourseViewModel vm)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] CourseViewModel vm)
        {
