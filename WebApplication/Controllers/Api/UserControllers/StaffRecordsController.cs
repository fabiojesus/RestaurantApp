...
namespace Recodme.Academy.RestaurantApp.WebApplication.Controllers.RestaurantControllers.Api.UserControllers
{
    ...
    [ApiController]
    public class StaffRecordsController : ControllerBase
    {
        ...
        public async Task<IActionResult> ListAsync()
        {
            ...
            {
                var vm = StaffRecordViewModel.Parse(item);
                lst.Add(vm);
            }
            return Ok(lst);
        }
        ...
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromBody] StaffRecordViewModel vm)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] StaffRecordViewModel vm)
        {
