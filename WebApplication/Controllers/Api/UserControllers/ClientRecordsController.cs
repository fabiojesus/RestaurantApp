...
namespace Recodme.Academy.RestaurantApp.WebApplication.Controllers.RestaurantControllers.Api.UserControllers
{
    ...
    public class ClientRecordsController : ControllerBase
    {
        ...
        public async Task<IActionResult> ListAsync()
        {
            ...
            {
                var vm = ClientRecordViewModel.Parse(item);
                lst.Add(vm);
            }
            return Ok(lst);
        }
        ...
        [HttpPost]
        public async Task<IActionResult> CreateAsync([FromBody] ClientRecordViewModel vm)
        {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] ClientRecordViewModel vm)
        {
