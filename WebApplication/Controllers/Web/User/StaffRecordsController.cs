...
namespace Recodme.Academy.RestaurantApp.WebApplication.Controllers.RestaurantControllers.Web.UserControllers
{
    ...
    {
        private readonly StaffRecordBusinessObject _bo = new StaffRecordBusinessObject();
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var lst = new List<StaffRecordViewModel>();
            foreach (var item in listOperation.Result)
            {
                lst.Add(StaffRecordViewModel.Parse(item));
            }
            ViewData["Header"] = "StaffRecords";
            return View(lst);
        }
        ...
        public async Task<IActionResult> Details(Guid? id)
        {
            ...
            var vm = StaffRecordViewModel.Parse(getOperation.Result);
            ViewData["Header"] = "StaffRecord";
            return View(vm);
        }
        ...
        public async Task<IActionResult> Create(StaffRecordViewModel vm)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, StaffRecordViewModel vm)
        {
            if (ModelState.IsValid)
            {
