...
namespace Recodme.Academy.RestaurantApp.BusinessLayer.BusinessObjects.MenuBusinessObjects
{
    public class MenuBusinessObject
    {
        ...
        public virtual OperationResult Create(Menu clientRecord)
        {
            try
            {
        ...
        public async virtual Task<OperationResult> CreateAsync(Menu clientRecord)
        {
            try
            {
        ...
        #region Update
        public virtual OperationResult Update(Menu clientRecord)
        {
            try
            {
                using var transactionScope = new TransactionScope(TransactionScopeOption.Required, transactionOptions, TransactionScopeAsyncFlowOption.Enabled);
        ...
        public async virtual Task<OperationResult> UpdateAsync(Menu clientRecord)
        {
            try
            {
                using var transactionScope = new TransactionScope(TransactionScopeOption.Required, transactionOptions, TransactionScopeAsyncFlowOption.Enabled);
        ...
        #region Delete
        public virtual OperationResult Delete(Menu clientRecord)
        {
            try
            {
        ...
        public async virtual Task<OperationResult> DeleteAsync(Menu clientRecord)
        {
            try
            {
                using var transactionScope = new TransactionScope(TransactionScopeOption.Required, transactionOptions, TransactionScopeAsyncFlowOption.Enabled);
